              ...
              <div class="col-md-6">
                <form>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label>Email</label>
                      <input type="email" class="form-control" value="<?php echo htmlspecialchars($userInfo['email'] ?? ''); ?>" disabled>
                    </div>
                    <div class="form-group">
                      <label>Contact Number</label>
                      <input type="text" class="form-control" value="<?php echo htmlspecialchars($userInfo['contact_number'] ?? ''); ?>" disabled>
                    </div>
                    <div class="form-group">
                      <label>Bio</label>
                      <textarea class="form-control" disabled><?php echo htmlspecialchars($userInfo['bio_description'] ?? ''); ?></textarea>
                    </div>  
                  </div>
                </form>
              </div>
