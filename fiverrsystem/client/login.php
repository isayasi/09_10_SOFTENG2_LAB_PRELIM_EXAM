...
<html lang="en">
  <head>
    ...
    .btn-primary:hover {
      ...
      background: linear-gradient(45deg, #0097a7, #007c91);
      color: white;
    }
            ...
            <form action="core/handleForms.php" method="POST">
              ...
              ?>
                ...
                <div class="form-group">
                  ...
                  <p>Are you an freelancer? You may <a href="../freelancer/login.php"> login here!</a></p>
                  <p>Are you an admin? You may <a href="../admin/login.php"> login here!</a></p>
                </div>
              </div>
            </form>
          </div>
